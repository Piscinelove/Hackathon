...
<head>
    ...
    <link rel="stylesheet" href="../css/disponibilities.css" />
    ...
    function c(passed_month, passed_year, calNum) {
        ...
        for (var cell = 0; cell < 42 - r; cell++) { // 42 date-cells in calendar
            if (cell >= calMonthArray.length) {
                ...
                if (
                    (
                        (shownDate != today.getDate() && passed_month == today.getMonth()) || passed_month != today.getMonth()
                    ) && iter_date < today) {
        ...
        clickedElement.on("click", function() {
            if (!$(this).hasClass('past-date')) {
                ...
                var monthg = (Number(passed_month) + 1);
                if (monthg < 10) {
                    monthg = "0" + monthg;
                }
                var dayg = this.innerHTML;
                if (dayg < 10) {
                    dayg = "0" + dayg;
                }
                daySelected = passed_year + "-" + monthg + "-" + dayg;
            }
                ...
                <div class="calendar-section">
                    ...
                    <div class="row">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label for="start" class="col-2 col-form-label">Heure de début</label>
                            </div>
                            <div class="col-lg-6">
                                <input class="form-control" type="text" id="start" placeholder="hh:mm">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label for="end" class="col-2 col-form-label">Heure de fin</label>
                            </div>
                            <div class="col-lg-6">
                                <input class="form-control" type="text" id="end" placeholder="hh:mm">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label for="repeat" class="col-2 col-form-label">Répétion</label>
                            </div>
                            <div class="col-lg-6">
                                <input class="form-control" type="number" id="repeat" value="0">
                            </div>
                        </div>
                    </div>
                    <div class="row">
