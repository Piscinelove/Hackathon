<?php
	...
	$coursing = Load::load('Course');
	$info = $coursing->getCourseById($_GET['id']);
?>
		...
		<section id="section-display-profile">
			<div class="container-fluid">
				...
				<div class="course-information">
					...
					<div class="row">
						<div class="col-md-3">
							<h5 class="h5-detail">Nombre de participants maximum</h5>
						</div>
						<div class="col-md-9">
							<?= $info['nbUsers'] ?> personne(s)
						</div>
					</div>
					<div class="row">
						<div class="col-md-3">
							<h5 class="h5-detail">Nom de l'enseignant</h5>
						</div>
						<div class="col-md-9">
					...
					<div class="row">
						<div class="col-md-3">
							<h5 class="h5-detail">Prix à l'heure</h5>
						</div>
						<div class="col-md-9">
							<?= $info['prixHeure']?>.- Fr / H
						</div>
